...
| P02 | E2 | Elegir un ítem inexistente | id = -1 | mensaje claro, el menú sigue | | |
| P03 | E2 | Operación recursiva sobre un ítem con cadena | id = 1 | imprime la cadena completa | | |
| P04 | E2 | Operación recursiva sobre un ítem sin derivados | id = 5 | solo el propio ítem (caso base) | | |
| P05 | E2 | Ver el detalle de un ítem que existe | id = 1 | muestra todos sus datos | | |
| P06 | E2 | Ver el detalle de un ítem que NO existe | id = 999 | mensaje claro, no se corta el programa | | |
| P07 | E2 | Elegir una opción de menú inválida | opción "9z" | vuelve a mostrar el menú | | |
| P08 | E2 | Pasar enter vacío en el menú | texto vacío | no explota, vuelve a preguntar | | |
